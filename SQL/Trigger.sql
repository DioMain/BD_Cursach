...
BEGIN
    ...
    DELETE FROM ADMIN.DIAGNOSES
           WHERE ADMIN.DIAGNOSES.DISEASE_ID = :OLD.DISEASE_ID;
end;

CREATE OR REPLACE TRIGGER DELETE_MEDICINE_LINKS_TRIGGER
BEFORE DELETE
ON ADMIN.MEDICINES
FOR EACH ROW
BEGIN
    DELETE FROM ADMIN.DIAGNOSESTOMEDICINES
           WHERE ADMIN.DIAGNOSESTOMEDICINES.MEDICINE_ID = :OLD.MEDICINE_ID;
end;
...
DROP TRIGGER DELETE_MEDICINE_LINKS_TRIGGER;
